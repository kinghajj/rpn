 ...
 *
 * In the current version, 2.0.0.0-alpha, I've re-written the program in C++.
 ...
 * with them. This alpha does not, however, have all of the command-line
 * features of the C version, nor the help command.
 *
